...
function httpGet(url)
{
    ...
    xmlHttp.send( null );
    alert("Thanks for letting us know about this page. GeoTag-X moderators will browse through this page and add the interesting images to GeoTagX for analysis manually.")
    console.log("Thanks for letting us know about this page. GeoTag-X moderators will browse through this page and add the interesting images to GeoTagX for analysis manually.")
